...
public class EmailMetadata extends AuditFields<String> {
	...
	private IndividualTone individualToneIdindividualTone;
	...
	public IndividualTone getIndividualToneIdindividualTone() {
		return individualToneIdindividualTone;
	}

	public void setIndvidualToneIdindividualTone(IndividualTone individualToneIdindividualTone) {
		this.individualToneIdindividualTone = individualToneIdindividualTone;
	}
